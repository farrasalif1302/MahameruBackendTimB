...
@bp.route('/add',methods=['POST']) # KELAR
...
@bp.route('/update/<id>',methods=['PUT']) # jadiin update channel
...
@bp.route('/show') #tampilin channel (kelar)
def channel_all():
    mongo = PyMongo(current_app)
...
'''
@bp.route('/delete/<id>',methods=['DELETE']) # hapus channel sesuai dengan channel ID
